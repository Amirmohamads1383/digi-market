  ...
  return (
    <div className="flex items-center justify-between">
      <div className="flex items-center gap-3">
        ...
        <div className="flex items-center pl-1 pr-3 w-100 max-w-xl h-12 bg-[#FAFAFA] border border-Caption/35 rounded-xl overflow-hidden">
      ...
      <div className="flex items-center gap-3">
        <Link to={"/cart"}>
          <button className="flex items-center justify-center w-12 h-12 text-Primary hover:text-white hover:bg-Primary border border-Caption/35 hover:border-Primary rounded-lg cursor-pointer transition-all">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width={20}
              height={20}
        ...
        <button className="flex items-center gap-2.5 px-4 h-12 font-bold text-Title border border-Caption/35 rounded-lg cursor-pointer">
          ورود / ثبت نام
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width={20}
